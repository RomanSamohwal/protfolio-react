...
export const Menu: React.FC<MenuProps> = ({isActiveMenu, onActiveMenuClick}) => {

    return <div className={isActiveMenu ? 'menu active' : 'menu'}>
        <div className='menu__block'>
            <div className="menu__close" onClick={onActiveMenuClick}>
